        ...
        <>
            <div className="ml-2" onClick={
                () => setLgShow(true)}>{photoURL ?
                    ...
                    <FontAwesomeIcon size="2x" icon={faUserPlus} />}</div>
            <Modal
                className="bg-dark"
                size="md"
                show={lgShow}
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title id="example-modal-sizes-title-lg" >
                        {photoURL ? <img width="160px" className="card" style={{ boxShadow: "3px 3px 3px gray" }} src={photoURL} alt="" srcset="" /> : <FontAwesomeIcon size="2x" icon={faUserPlus} />}
